...
export const Ourstory = () => {
    return (
      <section className="w-full h-fit flex flex-col-reverse md:flex-row items-center justify-between">
        <div className="w-[525px] h-fit flex flex-col gap-10 text-black mx-auto p-4 md:p-6 lg:p-8">
